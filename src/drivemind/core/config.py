...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    "mindmap": {
        ...
        # オフの場合、デバイス名を出力せず、パーティションを第一階層にします。
        "output_device_name": False,
        # オフの場合、プログラムフォルダは「プログラム：名前」としてまとめて出力します。
        "include_program_folders": False,
        # オンの場合、Adobe 系プロジェクトはフォルダだけを出力します。
        "adobe_project_folder_only": True,
    },
    "catalogs": {
